...
class OpenFile {
  public:
	...
	//Khai bao bien dung de luu phuong thuc mo file
	int type;

    OpenFile(int f) { file = f; currentOffset = 0; type = 0; }	// open the file
    OpenFile(int f, int t) { file = f, currentOffset = 0; type = t; } // mo file voi cac phuong thuc khac nhau
...
class OpenFile {
  public:	
	...
	//Khai bao bien dung du luu cac phuong thuc mo file khac nhau
	int type;

    OpenFile(int sector);		// Open a file whose header is located
					// at "sector" on the disk

	 OpenFile(int sector, int type);	// mo file voi cac phuong thuc khac nhau
